...
public class App {
    ...
    /**
     * "Contrary to other bridging modules, namely jcl-over-slf4j and log4j-over-slf4j,
     * which reimplement JCL and respectively log4j, the jul-to-slf4j module does not reimplement
